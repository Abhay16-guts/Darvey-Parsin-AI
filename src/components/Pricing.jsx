...
const plans = [
    ...
    },
    {
        name: "Professional",
        price: "4999₹",
        description: "Best for the growing businesses.",
        features: [
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 sm:mb-16 lg:mb-20">
                    <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                        ...
                        <br />
                        <span className="bg-linear-to-b from-blue-400 to-cyan-300 bg-clip-text text-transparent">Pricing Plans</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
                    {plans.map((plan, key) => (
                        <div key={key} className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full ${
                            ...
                            <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row">
                                {plan.features.map((feature, featureKey)=> (
                                    <li key={featureKey} className="flex items-start space-x-2 sm:space-x-3 ">
                                        <div className="shrink-0 h-4 w-4 sm:h-5 sm:w-5 rounded-full bg-blue-500/20 flex items-center justify-center mt-1">
                            ...
                            <button className={`w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg font-semibold ${
                                plan.mostPopular
                ...
                <div className="mt-8 sm:mt-12 text-center">
                    <p className="text-gray-400 text-xl">
                        Need a custom plan? <a href="#" className="text-blue-400 hover:text-blue-300">Contact us</a> for more information.
                    </p>
                </div>
            </div>
        </section>
